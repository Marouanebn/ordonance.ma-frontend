...
const SidebarPharmacien = ({ onMenuSelect }) => {
    ...
    const menuItems = [
        { label: "Tableau de bord", icon: <LayoutDashboard />, path: "/dashboard-pharmacien" },
        { label: "Recherche Ordonnance", icon: <FileText />, action: () => onMenuSelect && onMenuSelect('valider') },
        { label: "Ordonnances validées", icon: <Archive />, action: () => onMenuSelect && onMenuSelect('validated') },
                ...
                <div className="sidebar-bottom">
                    ...
                    <div className="sidebar-footer flex items-center gap-3 mt-4 pt-4 border-t border-gray-300" style={{ flexDirection: "column", alignItems: "flex-start" }}>
                        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                            <img src="/path-to-pharmacien-image.jpg" alt={user.name} className="doctor-avatar" style={{ width: 48, height: 48, borderRadius: "50%" }} />
                            <div>
