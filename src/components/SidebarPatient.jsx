...
const SidebarPatient = ({ onMenuSelect }) => {
    ...
    const menuItems = [
        ...
        { label: "Mes ordonnances", icon: <FileText />, action: () => onMenuSelect && onMenuSelect('ordonnances') },
                ...
                <div className="sidebar-bottom">
                    ...
                    <div className="sidebar-footer flex items-center gap-3 mt-4 pt-4 border-t border-gray-300" style={{ flexDirection: "column", alignItems: "flex-start" }}>
                        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                            <img src="/path-to-patient-image.jpg" alt={user.name} className="doctor-avatar" style={{ width: 48, height: 48, borderRadius: "50%" }} />
                            <div>
